...
axvline(L3_total / 4, color="C2", linewidth=3, ls="dotted")
text(L3_total / 4, 75, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
...
axvline(L3_total / 4, color="C2", linewidth=3, ls="dotted")
text(L3_total / 4, 50, "L3/core", rotation=90, va="center", ha="left", color="C2", fontsize=19)
...
axvline(L3_total / 4, color="C2", linewidth=3, ls="dotted")
text(L3_total / 4, 50, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 100])
xlabel("Buffer Size")
...
axvline(L3_total / 4, color="C2", linewidth=3, ls="dotted")
text(L3_total / 4, 34, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 46])
xlabel("Buffer Size")
...
axvline(L3_total / 4, color="C2", linewidth=3, ls="dotted")
text(L3_total / 4, 23, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 46])
xlabel("Buffer Size")
