...
const datadir = joinpath(@__DIR__, "../data/cpu-ring-bandwidth/i9-7900x")
...
data_block_empty = load_data(joinpath(datadir,
                                      "empty-blockring_read.csv"),
                             joinpath(datadir,
                                      "empty-blockring_write.csv"))
...
data_pipe_empty = load_data(joinpath(datadir,
                                     "empty-datapipe_read.csv"),
                            joinpath(datadir,
                                     "empty-datapipe_write.csv"))
...
text(L3_total / ncores_phys, 90, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
...
axvline(L3_total / ncores_phys, color="C2", linewidth=3, ls="dotted")
text(L3_total / ncores_phys, 70, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 100])
xlabel("Buffer Size")
...
axvline(L3_total / ncores_phys, color="C2", linewidth=3, ls="dotted")
text(L3_total / ncores_phys, 15, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 46])
xlabel("Buffer Size")
...
axvline(L3_total / ncores_phys, color="C2", linewidth=3, ls="dotted")
text(L3_total / ncores_phys, 80, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 100])
xlabel("Buffer Size")
...
axvline(L3_total / ncores_phys, color="C2", linewidth=3, ls="dotted")
text(L3_total / ncores_phys, 25, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 46])
xlabel("Buffer Size")
