...
const datadir = joinpath(@__DIR__, "../data/cpu-write-bandwidth/i9-7900x")
...
xticks(2.0.^(14:2:20), size_to_str.(2.0.^(14:2:20)))
ax.set_xticks(2.0.^(13:20), minor=true)
...
xlabel("Buffer Size")
ylabel("Total Throughput (B/ns)")
xticks(2.0.^(16:4:28), size_to_str.(2.0.^(16:4:28)))
ax.set_xticks(2.0.^(13:28), minor=true)
ax.xaxis.set_minor_formatter(matplotlib.ticker.NullFormatter())
