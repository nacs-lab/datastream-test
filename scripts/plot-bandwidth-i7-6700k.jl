...
const datadir = joinpath(@__DIR__, "../data/cpu-write-bandwidth/i7-6700k")
...
xticks(2.0.^(13:2:17), size_to_str.(2.0.^(13:2:17)))
ax.set_xticks(2.0.^(13:18), minor=true)
...
xticks(2.0.^(20:2:28), size_to_str.(2.0.^(20:2:28)))
ax.set_xticks(2.0.^(19:29), minor=true)
ax.xaxis.set_minor_formatter(matplotlib.ticker.NullFormatter())
yticks([30, 100], ["30", "100"])
ax.set_yticks(10:10:220, minor=true)
...
xlabel("Total Buffer Size")
ylabel("Cache Miss (%)")
xticks(2.0.^(22:2:28), size_to_str.(2.0.^(22:2:28)))
ax.set_xticks(2.0.^(22:29), minor=true)
ax.xaxis.set_minor_formatter(matplotlib.ticker.NullFormatter())
