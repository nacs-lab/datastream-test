...
data_block = load_data(joinpath(datadir, "ring-bandwidth-i9-10885h_blockring_read.csv"),
                       joinpath(datadir, "ring-bandwidth-i9-10885h_blockring_write.csv"))
data_block_empty = load_data(joinpath(datadir,
                                      "ring-bandwidth-empty-i9-10885h_blockring_read.csv"),
                             joinpath(datadir,
                                      "ring-bandwidth-empty-i9-10885h_blockring_write.csv"))

data_pipe = load_data(joinpath(datadir, "ring-bandwidth-i9-10885h_datapipe_read.csv"),
                      joinpath(datadir, "ring-bandwidth-i9-10885h_datapipe_write.csv"))
data_pipe_empty = load_data(joinpath(datadir,
                                     "ring-bandwidth-empty-i9-10885h_datapipe_read.csv"),
                            joinpath(datadir,
                                     "ring-bandwidth-empty-i9-10885h_datapipe_write.csv"))

const prefix = joinpath(@__DIR__, "../imgs/ring-bandwidth-i9-10885h")
...
grid()
axhline(1024 / 25, color="r", linewidth=2, ls="dotted")
text(1.6 * 2.0^26, 1024 / 25, "25 B/ns", va="bottom", ha="center", color="r", fontsize=19)
axvline(L3_total, color="C2", linewidth=3)
text(L3_total, 90, "L3", rotation=90, va="center", ha="right", color="C2", fontsize=19)
axvline(L3_total / 8, color="C2", linewidth=3, ls="dotted")
text(L3_total / 8, 75, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
...
axvline(L3_total / 8, color="C2", linewidth=3, ls="dotted")
text(L3_total / 8, 50, "L3/core", rotation=90, va="center", ha="left", color="C2", fontsize=19)
...
axvline(L3_total / 8, color="C2", linewidth=3, ls="dotted")
text(L3_total / 8, 50, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 100])
xlabel("Buffer Size")
...
axvline(L3_total / 8, color="C2", linewidth=3, ls="dotted")
text(L3_total / 8, 14, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 46])
xlabel("Buffer Size")
...
axvline(L3_total / 8, color="C2", linewidth=3, ls="dotted")
text(L3_total / 8, 23, "L3/core", rotation=90, va="center", ha="right", color="C2", fontsize=19)
legend(fontsize="x-small", ncol=1, columnspacing=1, handlelength=1)
xscale("log")
ylim([0, 46])
xlabel("Buffer Size")
