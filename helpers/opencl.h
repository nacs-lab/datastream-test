...
NACS_EXPORT(ds_helper) std::vector<cl::Device> all_ocl2_devices(bool includecpu);
NACS_EXPORT(ds_helper) std::vector<cl::Device> all_ocl2_devices(const YAML::Node *filter=nullptr);
